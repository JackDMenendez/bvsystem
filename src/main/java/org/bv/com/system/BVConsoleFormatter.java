...
public class BVConsoleFormatter extends Formatter {
	public static String DefaultConsoleFormatter = "org.bv.com.system.BVConsoleFormatter.format";
    ...
    public BVConsoleFormatter() {
    	format = System.getProperty(DefaultConsoleFormatter);
    	if (format == null)
    		format = getLoggingProperty(DefaultConsoleFormatter);
    	if (format == null)
    		format = "";
    }
