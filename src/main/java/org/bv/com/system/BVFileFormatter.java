...
public class BVFileFormatter extends Formatter {
	public static String DefaultFileFormatter = "org.bv.com.system.BVFileFormatter.format";
    ...
    public BVFileFormatter() {
    	format = System.getProperty(DefaultFileFormatter);
    	if (format == null)
    		format = getLoggingProperty(DefaultFileFormatter);
    	if (format == null)
    		format = "";
    }
